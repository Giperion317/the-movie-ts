import { Flex, Icon, BoxProps } from "@chakra-ui/react";
...
interface MainNavigationBoxProps extends BoxProps {
  children: React.ReactNode;
}

export const MainNavigationBox:React.FC<MainNavigationBoxProps> = ({ children }) => {
  return (
    <Flex
...
export const MainNavigationItem: React.FC<MainNavigationItemProps> = ({ name, to }) => {
...
interface MainNavigationIconProps {
  name: string;
  active: boolean;
}

const MainNavigationIcon:React.FC<MainNavigationIconProps> = ({ name, active }) => {
